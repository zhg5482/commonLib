 ...
 */
class CuvId extends DefaultVideo
{
    /** @var boolean */
    ...
    public function __construct($hardware = 'cuvid',$encode = 'h264_cuvid',$decode = 'h264_nvenc' )
    {
        $this->setVideoHardware($hardware)
            ->setVideoHardDeCode($decode)
            ->setVideoHardEnCode($encode);
    }
