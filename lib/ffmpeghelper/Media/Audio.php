...
use App\Lib\File\FFmpegHelper\Filters\Audio\AudioFilters;
...
use App\Lib\File\FFmpegHelper\Filters\Audio\AudioFilterInterface;
...
class Audio extends AbstractStreamableMedia
{
    ...
    public function save(FormatInterface $format, $outputPathfile,$unique_key=0)
    {
        ...
        if ($format instanceof ProgressableInterface) {
            $listeners = $format->createProgressListener($this, $this->ffprobe, 1, 1, 0,$unique_key);
        }
